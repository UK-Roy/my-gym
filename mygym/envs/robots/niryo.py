...
from mygym.envs.core import PyBulletRobot
from mygym.pybullet import PyBullet

robot_urdf = os.path.join(os.path.dirname(__file__), "urdf/v2/niryo_one.urdf")

class Niryo_One(PyBulletRobot):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            file_name=robot_urdf,
            base_position=base_position,
            action_space=action_space,
            joint_indices=np.array([1, 2, 3, 4, 5, 6]),
            joint_forces=np.array([87.0, 87.0, 12.0, 120.0, 170.0, 170.0]),
        )
        print("Hellow")
        self.fingers_indices = np.array([6])
